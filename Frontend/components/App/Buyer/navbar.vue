...
const navItems = [
  { to: '/Buyer/dashboard', label: 'Home', icon: 'i-lucide-home', color: 'text-blue-500' },
  { to: '/Buyer/products', label: 'Products', icon: 'i-heroicons-shopping-bag-solid', color: 'text-green-500' },
  { to: '/Buyer/reviews', label: 'Reviews', icon: 'i-heroicons-chat-bubble-left-right-solid', color: 'text-orange-500' },
  { to: '/Buyer/farmers', label: 'Farmers', icon: 'i-mdi-users', color: 'text-purple-500' }
];
