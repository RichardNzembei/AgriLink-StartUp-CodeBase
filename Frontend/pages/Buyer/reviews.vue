        ...
        <div v-if="seller.reviews?.length">
          <ul class="mt-4 space-y-3">
            <li v-for="review in seller.reviews" :key="review.userPhone"
              class="border border-gray-300 dark:border-gray-600 p-4 rounded-lg bg-white dark:bg-gray-400 shadow-sm flex flex-col gap-3 transition-all hover:shadow-lg">
